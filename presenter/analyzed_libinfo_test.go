...
//nolint:gocognit // test aggregates multiple getter checks for clarity
func TestAnalyzedLibInfo_Getters_NilAndValues(t *testing.T) {
	...
	if a1.Skip() == nil || *a1.Skip() != true {
		t.Fatalf("expected Skip=true from LibInfo")
	}
	if v := a1.SkipReason(); v == nil || *v != "li" {
	...
	if v := a2.Name(); v == nil || *v != "lib" {
		t.Fatalf("unexpected Name")
	}
	if v := a2.RepositoryURL(); v == nil || *v != "https://github.com/x/y" {
		t.Fatalf("unexpected RepositoryURL")
	}
	if v := a2.Watchers(); v == nil || *v != 1 {
		t.Fatalf("unexpected Watchers")
	}
	if v := a2.Stars(); v == nil || *v != 2 {
		t.Fatalf("unexpected Stars")
	}
	if v := a2.Forks(); v == nil || *v != 3 {
		t.Fatalf("unexpected Forks")
	}
	if v := a2.OpenIssues(); v == nil || *v != 4 {
		t.Fatalf("unexpected OpenIssues")
	}
if v := a2.LastCommitDate(); v == nil || *v != "2024-01-01T00:00:00Z" { //nolint:lll
		t.Fatalf("unexpected LastCommitDate")
	}
	if v := a2.GithubRepoURL(); v == nil || *v != "https://github.com/x/y" {
		t.Fatalf("unexpected GithubRepoURL")
	}
	if v := a2.Archived(); v == nil || *v != true {
		t.Fatalf("unexpected Archived")
	}
	if v := a2.Score(); v == nil || *v != 42 {
		t.Fatalf("unexpected Score")
	}
	if v := a2.Skip(); v == nil || *v != false {
		t.Fatalf("unexpected Skip false")
	}
	if a2.SkipReason() != nil {
	...
	if v := a3.Skip(); v == nil || *v != true {
		t.Fatalf("expected Skip true from LibInfo")
	}
	if v := a3.SkipReason(); v == nil || *v != "reason" {
	...
	if v := a4.Skip(); v == nil || *v != true {
		t.Fatalf("expected Skip true from RepoInfo")
	}
	if v := a4.SkipReason(); v == nil || *v != "repo-reason" {
